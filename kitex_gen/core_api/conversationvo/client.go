...
type kConversationVOClient struct {
	*kClient
}

func (p *kConversationVOClient) CreateConversation(ctx context.Context, Req *core_api.CreateConversationReq, callOptions ...callopt.Option) (r *core_api.CreateConversationResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateConversation(ctx, Req)
}

func (p *kConversationVOClient) ListConversations(ctx context.Context, Req *core_api.ListConversationsReq, callOptions ...callopt.Option) (r *core_api.ListConversationsResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListConversations(ctx, Req)
}

func (p *kConversationVOClient) GetConversation(ctx context.Context, Req *core_api.GetConversationReq, callOptions ...callopt.Option) (r *core_api.GetConversationResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
