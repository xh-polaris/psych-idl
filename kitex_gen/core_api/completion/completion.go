...
var (
	completionServiceInfo                = NewServiceInfo()
	completionServiceInfoForClient       = NewServiceInfoForClient()
	completionServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return completionServiceInfo
}

// for stream client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return completionServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return completionServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*core_api.Completion)(nil)
...
func createConversationHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core_api.Completion).CreateConversation(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *CreateConversationArgs:
		success, err := handler.(core_api.Completion).CreateConversation(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listConversationsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core_api.Completion).ListConversations(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListConversationsArgs:
		success, err := handler.(core_api.Completion).ListConversations(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getConversationHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(core_api.Completion).GetConversation(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetConversationArgs:
		success, err := handler.(core_api.Completion).GetConversation(ctx, s.Req)
		if err != nil {
			return err
		}
