...
type kOpenAPIClient struct {
	*kClient
}

func (p *kOpenAPIClient) OpenApiChatCompletion(ctx context.Context, Req *core_api.OpenApiChatCompletionReq, callOptions ...callopt.Option) (r *core_api.OpenApiChatCompletionResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.OpenApiChatCompletion(ctx, Req)
}
