...
type kConversationClient struct {
	*kClient
}

func (p *kConversationClient) CreateConversation(ctx context.Context, Req *core_api.CreateConversationReq, callOptions ...callopt.Option) (r *core_api.CreateConversationResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateConversation(ctx, Req)
}

func (p *kConversationClient) ListConversations(ctx context.Context, Req *core_api.ListConversationsReq, callOptions ...callopt.Option) (r *core_api.ListConversationsResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
