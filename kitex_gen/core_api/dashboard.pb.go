...
func (x *DashboardGetDataOverviewReq) GetStartTime() int64 {
...
func (x *DashboardGetDataOverviewReq) GetEndTime() int64 {
...
func (x *DashboardGetDataTrendReq) GetStartTime() int64 {
	if x != nil && x.StartTime != nil {
		return *x.StartTime
	}
	return 0
...
func (x *DashboardGetDataTrendReq) GetEndTime() int64 {
	if x != nil && x.EndTime != nil {
		return *x.EndTime
	}
	return 0
...
type DashboardGetDataTrendResp struct {
	...
	// 风险用户分布-按年级
	RiskDistribution *RiskDistributionByGrade `protobuf:"bytes,4,opt,name=riskDistribution" json:"riskDistribution,omitempty"`
	Code             int32                    `protobuf:"varint,255,opt,name=code" json:"code,omitempty"`
	Msg              string                   `protobuf:"bytes,256,opt,name=msg" json:"msg,omitempty"`
}
...
func (x *RiskDistributionByGrade) Marshal(in []byte) ([]byte, error) {
	return prutal.MarshalAppend(in, x)
}

func (x *RiskDistributionByGrade) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *DashboardGetPsychTrendReq) GetStartTime() int64 {
	if x != nil && x.StartTime != nil {
		return *x.StartTime
	}
	return 0
...
func (x *DashboardGetPsychTrendReq) GetEndTime() int64 {
	if x != nil && x.EndTime != nil {
		return *x.EndTime
	}
	return 0
...
func (x *DashboardGetAlarmOverviewReq) GetStartTime() int64 {
	if x != nil && x.StartTime != nil {
		return *x.StartTime
	}
	return 0
...
func (x *DashboardGetAlarmOverviewReq) GetEndTime() int64 {
	if x != nil && x.EndTime != nil {
		return *x.EndTime
	}
	return 0
