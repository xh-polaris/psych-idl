...
type UnitVO struct {
	...
	Scene        string `protobuf:"bytes,13,opt,name=scene" json:"scene,omitempty"`
	TeacherImage string `protobuf:"bytes,14,opt,name=teacherImage" json:"teacherImage,omitempty"`
}
