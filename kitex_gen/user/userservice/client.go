...
func (p *kUserServiceClient) UserSignUp(ctx context.Context, Req *user.UserSignUpReq, callOptions ...callopt.Option) (r *basic.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserSignUp(ctx, Req)
}

func (p *kUserServiceClient) UserGetInfo(ctx context.Context, Req *user.UserGetInfoReq, callOptions ...callopt.Option) (r *user.UserGetInfoResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserGetInfo(ctx, Req)
}

func (p *kUserServiceClient) UserUpdateInfo(ctx context.Context, Req *user.UserUpdateInfoReq, callOptions ...callopt.Option) (r *basic.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserUpdateInfo(ctx, Req)
}

func (p *kUserServiceClient) UserUpdatePassword(ctx context.Context, Req *user.UserUpdatePasswordReq, callOptions ...callopt.Option) (r *basic.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserUpdatePassword(ctx, Req)
}

func (p *kUserServiceClient) UserBelongUnit(ctx context.Context, Req *user.UserBelongUnitReq, callOptions ...callopt.Option) (r *user.UserBelongUnitResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserBelongUnit(ctx, Req)
}

func (p *kUserServiceClient) UserSignIn(ctx context.Context, Req *user.UserSignInReq, callOptions ...callopt.Option) (r *basic.Response, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
