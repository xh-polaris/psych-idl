...
var (
	viewServiceInfo                = NewServiceInfo()
	viewServiceInfoForClient       = NewServiceInfoForClient()
	viewServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return viewServiceInfo
}

// for stream client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return viewServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return viewServiceInfoForClient
}
...
func viewSignUpHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewSignUp(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewSignUpArgs:
		success, err := handler.(user.View).ViewSignUp(ctx, s.Req)
		if err != nil {
			return err
		}
...
func viewGetInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewGetInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewGetInfoArgs:
		success, err := handler.(user.View).ViewGetInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func viewUpdateInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewUpdateInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewUpdateInfoArgs:
		success, err := handler.(user.View).ViewUpdateInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func viewUpdatePasswordHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewUpdatePassword(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewUpdatePasswordArgs:
		success, err := handler.(user.View).ViewUpdatePassword(ctx, s.Req)
		if err != nil {
			return err
		}
...
func viewBelongUnitHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewBelongUnit(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewBelongUnitArgs:
		success, err := handler.(user.View).ViewBelongUnit(ctx, s.Req)
		if err != nil {
			return err
		}
...
func viewSignInHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.View).ViewSignIn(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ViewSignInArgs:
		success, err := handler.(user.View).ViewSignIn(ctx, s.Req)
		if err != nil {
			return err
		}
