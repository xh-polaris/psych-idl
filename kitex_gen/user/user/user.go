...
func userSignUpHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserSignUp(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserSignUpArgs:
		success, err := handler.(user.User).UserSignUp(ctx, s.Req)
		if err != nil {
			return err
		}
...
func userGetInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserGetInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserGetInfoArgs:
		success, err := handler.(user.User).UserGetInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func userUpdateInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserUpdateInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserUpdateInfoArgs:
		success, err := handler.(user.User).UserUpdateInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func userUpdatePasswordHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserUpdatePassword(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserUpdatePasswordArgs:
		success, err := handler.(user.User).UserUpdatePassword(ctx, s.Req)
		if err != nil {
			return err
		}
...
func userBelongUnitHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserBelongUnit(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserBelongUnitArgs:
		success, err := handler.(user.User).UserBelongUnit(ctx, s.Req)
		if err != nil {
			return err
		}
...
func userSignInHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.User).UserSignIn(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UserSignInArgs:
		success, err := handler.(user.User).UserSignIn(ctx, s.Req)
		if err != nil {
			return err
		}
