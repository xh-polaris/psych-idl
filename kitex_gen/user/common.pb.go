...
type Unit struct {
	...
	Form           *Form  `protobuf:"bytes,12,opt,name=form" json:"form,omitempty"`
...
type UnitCreateAndLinkUserReq_U struct {
	...
	Options    *Form  `protobuf:"bytes,6,opt,name=options" json:"options,omitempty"`
}
