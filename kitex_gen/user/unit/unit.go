...
func unitSignUpHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitSignUp(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitSignUpArgs:
		success, err := handler.(user.Unit).UnitSignUp(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitGetInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitGetInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitGetInfoArgs:
		success, err := handler.(user.Unit).UnitGetInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitUpdateInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitUpdateInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitUpdateInfoArgs:
		success, err := handler.(user.Unit).UnitUpdateInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitUpdatePasswordHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitUpdatePassword(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitUpdatePasswordArgs:
		success, err := handler.(user.Unit).UnitUpdatePassword(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitCreateAndLinkUserHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitCreateAndLinkUser(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitCreateAndLinkUserArgs:
		success, err := handler.(user.Unit).UnitCreateAndLinkUser(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitCreateAndLinkViewHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitCreateAndLinkView(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitCreateAndLinkViewArgs:
		success, err := handler.(user.Unit).UnitCreateAndLinkView(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitStrongVerifyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitStrongVerify(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitStrongVerifyArgs:
		success, err := handler.(user.Unit).UnitStrongVerify(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitWeakVerifyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitWeakVerify(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitWeakVerifyArgs:
		success, err := handler.(user.Unit).UnitWeakVerify(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitCreateVerifyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitCreateVerify(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitCreateVerifyArgs:
		success, err := handler.(user.Unit).UnitCreateVerify(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitUpdateVerifyPasswordHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitUpdateVerifyPassword(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitUpdateVerifyPasswordArgs:
		success, err := handler.(user.Unit).UnitUpdateVerifyPassword(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitLinkUserHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitLinkUser(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitLinkUserArgs:
		success, err := handler.(user.Unit).UnitLinkUser(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitLinkViewHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitLinkView(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitLinkViewArgs:
		success, err := handler.(user.Unit).UnitLinkView(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitPageQueryUserHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitPageQueryUser(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitPageQueryUserArgs:
		success, err := handler.(user.Unit).UnitPageQueryUser(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitPageQueryViewHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitPageQueryView(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitPageQueryViewArgs:
		success, err := handler.(user.Unit).UnitPageQueryView(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitGetAppInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitGetAppInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitGetAppInfoArgs:
		success, err := handler.(user.Unit).UnitGetAppInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitModelGetInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitModelGetInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitModelGetInfoArgs:
		success, err := handler.(user.Unit).UnitModelGetInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func unitModelUpdateInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(user.Unit).UnitModelUpdateInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnitModelUpdateInfoArgs:
		success, err := handler.(user.Unit).UnitModelUpdateInfo(ctx, s.Req)
		if err != nil {
			return err
		}
