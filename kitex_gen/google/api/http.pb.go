...
func (x *Http) Reset() { *x = Http{} }

func (x *Http) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *Http) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *HttpRule) Reset() { *x = HttpRule{} }

func (x *HttpRule) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *HttpRule) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
...
func (x *HttpRule) GetGet() string {
	if p, ok := x.GetPattern().(*HttpRule_Get); ok {
		return p.Get
	}
	return ""
}
...
func (x *HttpRule) GetPut() string {
	if p, ok := x.GetPattern().(*HttpRule_Put); ok {
		return p.Put
	}
	return ""
}
...
func (x *HttpRule) GetPost() string {
	if p, ok := x.GetPattern().(*HttpRule_Post); ok {
		return p.Post
	}
	return ""
}
...
func (x *HttpRule) GetDelete() string {
	if p, ok := x.GetPattern().(*HttpRule_Delete); ok {
		return p.Delete
	}
	return ""
}
...
func (x *HttpRule) GetPatch() string {
	if p, ok := x.GetPattern().(*HttpRule_Patch); ok {
		return p.Patch
	}
	return ""
}
...
func (x *HttpRule) GetCustom() *CustomHttpPattern {
	if p, ok := x.GetPattern().(*HttpRule_Custom); ok {
		return p.Custom
	}
	return nil
}
...
func (x *CustomHttpPattern) Reset() { *x = CustomHttpPattern{} }

func (x *CustomHttpPattern) Marshal(in []byte) ([]byte, error) { return prutal.MarshalAppend(in, x) }

func (x *CustomHttpPattern) Unmarshal(in []byte) error { return prutal.Unmarshal(in, x) }
